...
class MovimientoInventario(models.Model):
    class TipoMovimiento(models.TextChoices):
        ...
        LIBERACION = "LIBERACION", "Liberacion Reserva"
...
class Venta(models.Model):
    ...
    def __str__(self):
        return f"Venta {self.negocio} - {self.cliente}"
...
class Cliente(models.Model):
    negocio = models.ForeignKey(Negocio, on_delete=models.CASCADE, verbose_name='clientes')
